<template>
            ...
            <tbody class="divide-y divide-slate-100">
              ...
              <tr v-for="(position, index) in positions" :key="index"
                ...
                <td class="py-5 px-6 text-right relative">
                  <button @click.stop="toggleDropdown(position.id)"
  ...
  <ModalGeneric v-model="isDeleteModalOpen" title="Confirm Delete" width="440px">
    <div class="space-y-3">
    ...
    <template #footer>
      ...
      <button type="button" @click="handleConfirmDelete"
