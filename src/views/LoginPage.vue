...
<main class="flex-grow flex flex-col md:flex-row min-h-screen w-full">
    ...
    <div class="w-full md:w-1/2 bg-white flex flex-col p-8 md:p-16 lg:p-24 justify-between">
        <div class="my-auto flex justify-center items-center w-full">
            <form class="w-full max-w-[380px]" @submit.prevent="handleLogin">
                ...
                <div class="mb-5">
                    <label for="email" class="block text-[11px] font-semibold text-slate-500 uppercase tracking-wider mb-2">Email Address</label>
                    <input 
                        type="email" 
                        id="email" 
                ...
                <div class="mb-5">
                    <label for="password" class="block text-[11px] font-semibold text-slate-500 uppercase tracking-wider mb-2">Password</label>
                    <div class="relative">
                        <input 
                        ...
                        >
                            <svg v-if="!isPasswordVisible" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.2" stroke="currentColor" class="w-5 h-5">
                ...
                <div class="flex items-center mb-6">
                    ...
                    >
                    <label for="remember_me" class="ml-2 text-sm text-slate-500 font-light cursor-pointer select-none">Remember me</label>
                </div>
                <button 
                    type="submit" 
                ...
                <div class="flex flex-col items-center gap-2">
                    <router-link to="/forgot-password" class="text-xs text-slate-500 hover:text-black underline underline-offset-4 transition-colors font-light">
                        Forgot password?
                    </router-link>
                    <router-link to="/register" class="text-xs text-slate-500 hover:text-black underline underline-offset-4 transition-colors font-light">
                        Đăng ký tài khoản
                    </router-link>
                </div>
            </form>
