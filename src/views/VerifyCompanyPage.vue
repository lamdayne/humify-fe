        ...
        <main class="grow flex flex-col md:flex-row min-h-screen w-full">
            ...
            <div class="w-full md:w-1/2 bg-white flex flex-col p-8 md:p-16 lg:p-24 justify-between">
                <div class="my-auto flex justify-center items-center w-full">
                    ...
                    <!-- State: Verifying -->
                    <div v-if="status === 'verifying'" class="w-full max-w-95 text-center flex flex-col items-center">
                        ...
                        <p class="text-[14px] text-slate-500 font-light">Please wait while we verify your company
                            registration...</p>
                    </div>

                    <!-- State: Success -->
                    <div v-else-if="status === 'success'"
                        class="w-full max-w-95 text-center flex flex-col items-center">
                        <div
                            class="w-12 h-12 bg-emerald-50 text-emerald-600 rounded-full flex items-center justify-center mb-4">
                        ...
                        <p class="text-[14px] text-slate-500 mb-8 font-light">
                            Your company registration has been verified successfully. You can now sign in to your
                    ...
                    <!-- State: Error -->
                    <div v-else-if="status === 'error'" class="w-full max-w-95 text-center flex flex-col items-center">
                        <div
